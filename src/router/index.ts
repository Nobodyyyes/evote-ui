...
const router = createRouter({
    ...
    routes: [
        ...
        },
        {
            ...
            component: () => import('../views/ElectionDetailsView.vue'),
            meta: {requiresAuth: true}
        },
        {
            ...
            meta: {requiresAuth: true, roles: ['USER', 'ADMIN'] satisfies Role[]}
        },
        {
        ...
        },
        {
            ...
            component: () => import('../views/admin/ElectionFormView.vue'),
            meta: {requiresAuth: true, roles: ['ADMIN'] satisfies Role[]}
        },
        {
            path: '/admin/users',
        ...
        },
        {
            ...
            meta: {requiresAuth: true, roles: ['ADMIN', 'AUDITOR'] satisfies Role[]}
        },
        {
            path: '/admin/integrity',
            name: 'integrity',
            component: () => import('../views/admin/IntegrityView.vue'),
            meta: {requiresAuth: true, roles: ['ADMIN', 'AUDITOR'] satisfies Role[]}
        },
        {
